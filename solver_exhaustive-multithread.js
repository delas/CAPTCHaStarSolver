 ...
 * ============
 *
 * From http://keithwhor.github.io/multithread.js/:
 * > Additionally, threaded functions do not have access to the DOM.
 *
 */

/**
 * This procedure to load Multithread.js
 * (see http://keithwhor.github.io/multithread.js/). The actual procedure is
...
/**
 * Exhaustive search with multithreading support.
 */
function solveExhaustiveMT(canvas, fromX, toX, fromY, toY) {
	console.log("Exhaustive Solver with MultiThreading");
...
MT.process(solveExhaustiveMT, function(result){
	console.log("#1 The best configuration seems (" + result.bestX + ", " + result.bestY + "), score: " + result.bestScore);
})(document.getElementById("captcha"), 0, 150, 0, 300);

MT.process(solveExhaustiveMT, function(result){
	console.log("#2 The best configuration seems (" + result.bestX + ", " + result.bestY + "), score: " + result.bestScore);
})(document.getElementById("captcha"), 150, 300, 0, 300);
